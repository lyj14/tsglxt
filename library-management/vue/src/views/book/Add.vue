<template>
  <div style="
    ...
    border-radius: 10px;">
    <div style="margin-bottom: 40px; font-weight: bold; font-size: 38px;">新增图书</div>
    <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" label-width="100px">
      ...
      <el-form-item label="借书积分" prop="cover">
        <el-input-number style="width: 190px" v-model="form.score" :min="10" :max="30" label="所需积分"></el-input-number>
      </el-form-item>
