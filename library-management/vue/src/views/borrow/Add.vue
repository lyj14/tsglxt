  ...
  <div style="
    ...
    <el-form :inline="true" :rules="rules" ref="ruleForm" :model="form" label-width="100px">
      ...
      <el-form-item label="会员码" prop="userNo">
        <el-select style="width: 190px" v-model="form.userNo" filterable placeholder="请选择" @change="selUser">
          <el-option
              v-for="item in users"
              :key="item.id"
              :label="item.username"
      ...
      <el-form-item label="借出的天数" prop="days">
        <el-input-number v-model="form.days" :min="1" :max="30" label="借出的天数" style="width: 190px"></el-input-number>
      </el-form-item>
    </el-form>
